          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8 border-b border-gray-200 dark:border-gray-800 pb-4">
            ...
            <div className="sm:hidden w-full">
              <button
                ...
                className={`w-full group relative inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg text-sm font-bold transition-all duration-300 overflow-hidden shadow-sm hover:shadow-md ${showMobileSearch
